  ...
  <div class="carousel-inner relative overflow-hidden w-full">
    ...
    <div class="carousel-item absolute opacity-0 h-screen"  >
      <div class="block h-full w-full "> 
        <img src="../static/imgs/malvestida-DMl5gG0yWWY-unsplash.jpg" class="object-cover  w-full h-auto"/>
      </div>
    </div>
    ...
    <div class="carousel-item absolute opacity-0 h-screen" >
      <div class="block h-full w-full  ">
        <img src="../static/imgs/linda-xu-fUEP0djb1hA-unsplash.jpg" class="object-cover h-screen w-full"/>
      </div>
    </div>
    ...
    <div class="carousel-item absolute opacity-0 h-screen">
      <div class="block h-full w-full ">
        <img src="../static/imgs/hamza-nouasria-EdUIsPs-vOM-unsplash.jpg" class="object-cover h-screen w-full"/>
      </div>
    </div>
  ...
  <div class="container px-5 py-2 mx-auto lg:pt-24 lg:px-32">
    <div class="flex flex-wrap -m-1 md:-m-2">
      <div class="flex flex-wrap w-1/2">
        <div class="w-1/2 p-1 md:p-2">
          <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
            src="../static/imgs/mohammad-metri-E-0ON3VGrBc-unsplash.jpg">
        </div>
        <div class="w-1/2 p-1 md:p-2">
          <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
            src="../static/imgs/raquel-gambin-kS3YkVtf85U-unsplash.jpg">
        </div>
      ...
      <div class="flex flex-wrap w-1/2">
        ...
        <div class="w-1/2 p-1 md:p-2">
          <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
            src="../static/imgs/suheyl-burak-p7I07kuPSyU-unsplash.jpg">
        </div>
      </div>
    </div>
  </div>
